...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.obscure.imageview_ex.js')
	...
	f = os.path.join(cwd,'Classes','ComObscureImageview_exModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.obscure.imageview_ex.js']
